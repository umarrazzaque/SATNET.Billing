...
{
    public class HardwareAttributeController : Controller
    {
        ...
        public HardwareAttributeController(IMapper mapper, IService<Lookup> lookUpService)
        {
        ...
        {
            var statusModel = new StatusModel { IsSuccess = false, ResponseUrl = "/HardwareAttribute/Index" };
            ...
            statusModel.ResponseUrl = "/HardwareAttribute/Index";
